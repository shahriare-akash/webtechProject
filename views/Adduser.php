...
if(isset($_POST['Save']))
		{  	
			...
			elseif(strlen($_POST['Pnumber'])!=10)
			{
				$err_Pnumber3="*only input 10 digits number";
			}
...
?>
           ...
           <form class="user_form" action="" method="post">
			...
			Store: <br>	
			<select class="store"  class="Store">
				...
				<option>Food</option>
					...
					Username <br>  <input id="uname"  type="text" value="<?php echo $uname;?>"name="uname" placeholder="Enter Username"><br>
                    ...
                    Confirm Password <br> <input type="password"  value="<?php echo $cpass;?>"  name="confirmpass" placeholder="Confirm Password"> <br> 
					...
					<span style="color:green"><?php echo $cpass3;?></span>
					...
					Gender <br><input class="inputradio" type="radio" name="gender" value="<?php echo $gendervalue;?>"> Male <input  class="inputradio" type="radio" name="gender" value="<?php echo $gendervalue;?>"> Female
