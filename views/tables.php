...
<form onsubmit="return valid()" action="../controllers/tableController.php" method="post">
     <b> Table Name </b><br> 
     <input class="form form-control" type="text" name="name" id="name" placeholder="Enter Table Name"> <br>
	...
	<input class="btn btn-primary" type="submit" name="add_table" value="Add Table"></p>
</form>
