<?php include_once('stuffMain.php');
...
<form onsubmit="return valid()" action="../controllers/companyinfoController.php" method="post">
    ...
    Company Name <br> <input class="form form-control" type="text" name="cname" id="cname" value="<?php echo "$name"; ?>" disabled> <br><span class="text-danger font-weight-bold" id="err_cname"></span> <br> 
	<b>Charge Amount (%)</b> <br> 
    <input class="form form-control" type="text" name="amount" id="amountId" value="<?php echo $amount;?>" disabled> <br> 
    <span class="text-danger font-weight-bold" id="err_amount"></span><br>
    
    <b>Vat Charge (%)</b> <br> 
    <input class="form form-control" type="text" name="vat" id="vatId" value="<?php echo $vat; ?>" disabled> <br> 
    <span class="text-danger font-weight-bold" id="err_vat"></span><br>
	
    <b>Address </b><br><input class="form form-control" type="text" name="address" id="address" value="<?php echo $address; ?>" disabled> <br> 
    <span class="text-danger font-weight-bold" id="err_add"></span> <br>
	
    <b>Phone No </b><br> <input class="form form-control" type="text" name="phnNumber" id="phnNumber" value="<?php echo $number; ?>" disabled> <br> 
    <span class="text-danger font-weight-bold" id="err_num"></span><br>
    
    <b>Country</b><br> <input class="form form-control"  type="text" name="country" id="country" value="<?php echo $country; ?>" disabled> <br> 
    ...
    <b>Message</b>   <br>  <textarea class="form form-control" name="message" rows="6" cols="64" disabled> <?php echo $message; ?> </textarea> <br>
